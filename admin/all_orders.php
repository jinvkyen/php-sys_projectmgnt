...
<head>
    ...
    <title>KKOPI.Tea || All Orders</title>
         ...
         <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/kk.jpg" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Branch</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_restaurant.php">Add Branches</a></li>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			{
																			?>
																			<td> <button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Ready</button></td>
																		   <?php 
																			  }
																			...
																			if($status=="closed")
																				{
																			?>
																			<td> <button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Collected</button></td> 
																			<?php 
																			} 
																			?>
																			<?php
