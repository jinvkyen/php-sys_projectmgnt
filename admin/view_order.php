...
<head>
    ...
    <title>KKOPI.Tea || View Order</title>
													...
													<?php 
																		   ...
																		   <?php 
																			...
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Collected</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
